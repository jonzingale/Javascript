...
(function(){
  ...
  var world = d3.selectAll("#epidemics_display").append('canvas')
    .attr('width', world_width)
    .attr('height', world_width)
    .attr("class",'epidemics_display')
  ...
  var reset = { id:"epidemicsreset", name:"randomize",
  ...
  function runpause(d){ d.value == 1 ? t = d3.timer(epidemics,0) : t.stop(); }
